...
namespace GetDominantColor
{
    public partial class CustomColorThief
    {
        ...
        private object GetColorMap(byte[][] pixelArray, int colorCount)
        {
        ...
        private byte[][] ConvertPixels(byte[] pixels, int v, int quality, bool ignoreWhite)
        {
            throw new NotImplementedException();
        }
    }
